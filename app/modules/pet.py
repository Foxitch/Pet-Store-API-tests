...
class PetModule:
    ...
    def create_pet(self) -> Response:
        ...
        r = self.app.common.post_req(endpoint='/pet', headers=self.headers, data=data)
    ...
    def get_pet_by_id(self) -> Response:
        ...
        return self.app.common.get_req(endpoint=f'/pet/{self.created_pet_id}', headers=self.headers)
    ...
    def change_pet_info(self) -> Response:
        ...
        return self.app.common.put_req(endpoint=f'/pet/{self.created_pet_id}', headers=self.headers, data=data)
    ...
    def find_pets_by_status(self) -> tuple[Response, str]:
        ...
        return self.app.common.get_req(endpoint=f'/pet/findByStatus?status={status}', headers=self.headers), status

    def delete_pet(self) -> Response:
        """ https://petstore.swagger.io/#/pet/deletePet """

        return self.app.common.delete_req(endpoint=f'/pet/{self.created_pet_id}', headers=self.headers)
